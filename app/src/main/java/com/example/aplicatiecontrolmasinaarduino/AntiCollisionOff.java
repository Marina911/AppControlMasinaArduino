...
public class AntiCollisionOff extends AppCompatActivity {
    private static final String TAG = "AntiCollisionOff";
    ...
    final static String inainte = "w";
    final static String spate = "s";
    final static String dreapta = "d";
    final static String stanga = "a";
    final static String stop = "q";
    ...
    private class ConnectBluetooth extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(AntiCollisionOff.this, "Asteptati!", "Se conecteaza");
